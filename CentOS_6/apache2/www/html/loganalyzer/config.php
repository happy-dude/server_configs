...
$CFG['UserDBPort'] = 3306;
$CFG['UserDBName'] = 'loganalyzerdb'; 
$CFG['UserDBPref'] = 'logcon_'; 
$CFG['UserDBUser'] = 'loganalyzer';
$CFG['UserDBPass'] = 'eastCoLOGANAL-8664';
...
$CFG['ViewStringCharacterLimit'] = 80;		// Default character limit for all other string type fields before they get trunscated! 0 means NO trunscation.
$CFG['ViewEntriesPerPage'] = 200;			// Default number of syslog entries shown per page
...
$CFG['Sources']['Source1']['ID'] = 'Source1';
$CFG['Sources']['Source1']['Name'] = 'All Syslog Sources';
$CFG['Sources']['Source1']['ViewID'] = 'SYSLOG';
...
$CFG['Sources']['Source1']['DBName'] = 'rsyslogdb';

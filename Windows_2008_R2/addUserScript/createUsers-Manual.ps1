...
$middleName = Read-Host -Prompt "User's middle name"
$lastName= Read-Host -Prompt "User's last name"

#Get default password

$department= Read-Host -Prompt "Employee's Department"
$extension = Read-Host -Prompt "Employee's Phone Extension"
$empNumber = Read-Host -Prompt "Employee Number"
